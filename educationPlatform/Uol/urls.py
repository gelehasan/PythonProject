...
urlpatterns = [
    ...
    path('api/course/<str:pk>/', api.CourseDetail.as_view(), name='course_detail_api'),
    ...
    path('api/enrollments/course/<str:course_id>/', api.EnrollmentsByCourse.as_view(), name='enrollments_by_course'),  
    path('api/students/category/<str:category>/', api.StudentsByCourseCategory.as_view(), name='students_by_category'),
    path('api/reviews/course/<str:course_id>/', api.ReviewsByCourse.as_view(), name='reviews_by_course'),   
    ...
    path('course/<str:pk>/', views.CourseDetail.as_view(), name='course_detail'),   
    path('course/add/', views.CourseCreate.as_view(), name='course_add'),
    path('course/update/<str:pk>/', views.CourseUpdate.as_view(), name='course_update'),  
    path('course/delete/<str:pk>/', views.CourseDelete.as_view(), name='course_delete'),   
